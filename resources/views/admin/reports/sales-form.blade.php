            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-body p-5">
                    <div class="text-center mb-5">
                        <div class="d-inline-flex align-items-center justify-content-center bg-primary bg-opacity-10 text-primary rounded-4 mb-4" style="width: 80px; height: 80px;">
                            <i class="bi bi-file-earmark-bar-graph fs-1"></i>
                        </div>
                        <h2 class="fw-800 text-dark mb-2">Laporan Penjualan Tiket Vendor</h2>
                        <p class="text-secondary">Pilih rentang tanggal untuk mencetak laporan penjualan tiket</p>
                    </div>

                    <form action="{{ route('admin.reports.sales.print') }}" method="POST" target="_blank">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-primary btn-lg w-100 py-3 shadow-sm rounded-4 fw-800">
