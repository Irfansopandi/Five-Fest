...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('storage/images/logo/logo.png') }}?v=2">
    <link rel="shortcut icon" type="image/png" href="{{ asset('storage/images/logo/logo.png') }}?v=2">
    <link rel="apple-touch-icon" href="{{ asset('storage/images/logo/logo.png') }}?v=2">
