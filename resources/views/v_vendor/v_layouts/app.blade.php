...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('storage/images/logo/logow.png') }}?v=3">
    <link rel="shortcut icon" type="image/png" href="{{ asset('storage/images/logo/logow.png') }}?v=3">
