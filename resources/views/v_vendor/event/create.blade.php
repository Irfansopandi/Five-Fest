    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        <div class="d-flex align-items-center gap-3 w-100" style="min-width: 0;">
            ...
            <div style="min-width: 0; overflow: hidden;">
                <h3 class="fw-bold mb-0 text-truncate" style="letter-spacing: -0.5px;">Create New Masterpiece</h3>
                <p class="text-muted mb-0 text-truncate">Bagikan acaramu ke ribuan pembeli potensial.</p>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('vendor.events.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-lg-8">
                ...
                <div class="card form-section-card">
                    <div class="form-section-header">
                        ...
                        <h5 class="fw-bold mb-0">Konsep Acara</h5>
                    </div>
                    <div class="card-body p-4">
                        <div class="row g-3 mb-4">
                            <div class="col-md-8">
                                <label class="form-label-custom">Judul Event</label>
                                <input type="text" name="title" value="{{ old('title') }}" class="form-control form-control-custom @error('title') is-invalid @enderror" placeholder="Nama konser atau event Anda" required>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-4">
                                ...
                                <input type="date" name="date" value="{{ old('date') }}" class="form-control form-control-custom @error('date') is-invalid @enderror" required>
                                @error('date') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-4">
                                <label class="form-label-custom">Waktu Mulai</label>
                                <input type="time" name="time" value="{{ old('time') }}" class="form-control form-control-custom @error('time') is-invalid @enderror" required>
                                @error('time') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-4">
                                <label class="form-label-custom">Waktu Open Gate</label>
                                <input type="time" name="gate_open_time" value="{{ old('gate_open_time') }}" class="form-control form-control-custom @error('gate_open_time') is-invalid @enderror">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-8">
                                ...
                                <input type="text" name="venue" value="{{ old('venue') }}" class="form-control form-control-custom @error('venue') is-invalid @enderror" placeholder="Nama gedung atau tempat" required>
                                @error('venue') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-4">
                                <label class="form-label-custom">Max Tiket / User</label>
                                <input type="number" name="max_tickets_per_user" value="{{ old('max_tickets_per_user', 4) }}" class="form-control form-control-custom @error('max_tickets_per_user') is-invalid @enderror" min="1" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" rows="6" class="form-control form-control-custom @error('description') is-invalid @enderror" placeholder="Jelaskan detail event Anda..." required>{{ old('description') }}</textarea>
                ...
                <div class="card form-section-card">
                    <div class="form-section-header justify-content-between">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <h5 class="fw-bold mb-0">Merchandise (Opsional) <small class="fw-normal text-muted ms-2 fs-6">(Drag untuk atur urutan)</small></h5>
                        </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div id="merch-empty" class="text-center py-5">
                            <i class="bi bi-bag-x opacity-25 fs-1 d-block mb-2"></i>
                            <p class="text-muted small">Belum ada merchandise yang ditambahkan.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card form-section-card">
                    <div class="form-section-header">
                        ...
                        <h5 class="fw-bold mb-0">Poster Event</h5>
                    </div>
                    <div class="card-body p-4 text-center">
                        <div id="imagePreview" class="preview-box mb-3 d-none">
                            <img id="previewImg" src="" class="w-100" style="max-height: 400px; object-fit: cover;">
                        </div>
                        <div id="imagePlaceholder" class="preview-box mb-3">
                            <i class="bi bi-cloud-arrow-up fs-1 opacity-25"></i>
                        </div>
                        <input type="file" name="image" class="form-control form-control-custom @error('image') is-invalid @enderror" accept="image/*" onchange="previewImage(this, 'imagePreview', 'previewImg', 'imagePlaceholder')" required>
                ...
                <div class="card form-section-card">
                    <div class="form-section-header">
                        <i class="bi bi-map"></i>
                        <h5 class="fw-bold mb-0">Maps & Plans</h5>
                    </div>
                    <div class="card-body p-4">
                        <div class="mb-4">
                           <label class="form-label-custom">Peta Kursi (Seatmap)</label>
                            <div class="preview-box d-none mb-3" id="previewSeatContainer">
                                <img id="previewSeatImg" src="" class="w-100" style="max-height: 200px; object-fit: contain;">
                            </div>
                            <input type="file" name="seat_plan" class="form-control form-control-custom" accept="image/*" onchange="previewImage(this, 'previewSeatContainer', 'previewSeatImg')">
                            <small class="text-muted d-block mt-2">Format JPG/PNG, maksimal 10MB.</small>
                        </div>
                        <div class="mb-4">
                            <label class="form-label-custom">Denah Venue (Gate/Toilet/dll)</label>
                            <div class="preview-box d-none mb-3" id="previewVenueContainer">
                                <img id="previewVenueImg" src="" class="w-100" style="max-height: 200px; object-fit: contain;">
                            </div>
                            <input type="file" name="venue_map" class="form-control form-control-custom" accept="image/*" onchange="previewImage(this, 'previewVenueContainer', 'previewVenueImg')">
                            <small class="text-muted d-block mt-2">Format JPG/PNG, maksimal 10MB.</small>
                        </div>
                        <div class="mb-0">
                            <label class="form-label-custom">Link Google Maps</label>
                            <input type="url" name="venue_location_url" class="form-control form-control-custom" placeholder="https://goo.gl/maps/...">
                        </div>
                ...
                <div class="card form-section-card">
                    <div class="form-section-header">
                        ...
                        <h5 class="fw-bold mb-0">Publish Settings</h5>
                    </div>
                    <div class="card-body p-4">
                        <div class="mb-4">
                            <label class="form-label-custom">Waktu Open Sale (War Ticket)</label>
                            <input type="datetime-local" name="open_sale_at" value="{{ old('open_sale_at') }}" class="form-control form-control-custom @error('open_sale_at') is-invalid @enderror">
                            @error('open_sale_at') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="mb-4">
                            <label class="form-label-custom">S&K (Teks)</label>
                            <textarea name="terms" rows="4" class="form-control form-control-custom @error('terms') is-invalid @enderror" placeholder="Syarat dan ketentuan...">{{ old('terms') }}</textarea>
                        ...
                        <div class="mb-0 border-top pt-4 mt-4">
                            <div class="form-check form-switch d-flex align-items-center gap-3">
                                <input class="form-check-input custom-switch-purple" type="checkbox" role="switch" id="is_tenant_open" name="is_tenant_open" value="1" style="transform: scale(1.8); margin-top: 0; cursor: pointer;" onchange="toggleTenantSettings()">
                                <div>
                            ...
                            {{-- Tenant Settings (Hidden by default) --}}
                            <div id="tenant_settings_container" class="mt-4 p-4 bg-light rounded-4 border d-none">
                                <div class="mb-3">
                                    <label class="form-label-custom text-dark"><i class="bi bi-tag-fill me-1" style="color: #8b5cf6;"></i>Harga Sewa Booth (Rp)</label>
                                    <input type="number" name="tenant_booth_price" class="form-control form-control-custom" placeholder="Contoh: 500000" min="0" value="0">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="tenant_quota" class="form-control form-control-custom" placeholder="Contoh: 20" min="1">
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="mt-3 bg-white p-3 rounded-3 border border-purple">
                                        ...
                                        <input type="text" name="map_notice" class="form-control form-control-sm form-control-custom" placeholder="Contoh: Denah booth akan diinformasikan H-3">
        ...
        <div class="sticky-action-bar d-flex justify-content-between align-items-center">
            <div class="d-none d-md-block">
                <p class="mb-0 fw-bold text-dark">Rancang dengan teliti.</p>
                <p class="mb-0 small text-muted">Event Anda akan langsung masuk ke tahap moderasi/publish.</p>
            </div>
            <div class="d-flex gap-3">
                ...
                <button type="submit" class="btn btn-publish">
                    <i class="bi bi-send-check-fill me-2"></i> Publikasikan Event
                </button>
            </div>
        </div>
...
function addMerchRow() {
    document.getElementById('merch-empty').classList.add('d-none');
    ...
    div.innerHTML = `
        ...
        <div class="row g-4">
            <div class="col-md-3">
                ...
                <input type="file" name="merch_images[]" class="form-control form-control-sm mt-2" accept="image/*" onchange="previewImage(this, 'merchPreview_${index}', 'merchImg_${index}')">
...
function previewImage(input, previewId, imgId, placeholderId = null) {
